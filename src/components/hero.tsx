...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    gsap.set([".hero-badge", ".hero-name", ".hero-title", ".hero-description", ".hero-button", ".hero-stats"], {
      y: 30,
      opacity: 0
    });
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="hero-stats grid grid-cols-2 md:grid-cols-4 gap-6 max-w-2xl mx-auto">
          <div className="stat-card text-center p-6 rounded-2xl glass shadow-xl hover:border-primary/50 transition-colors group">
            <div className="text-4xl font-bold text-primary mb-2 group-hover:scale-110 transition-transform">2+</div>
            <div className="text-sm text-muted-foreground uppercase tracking-wider font-semibold">
              Years Experience
            </div>
          </div>
          <div className="stat-card text-center p-6 rounded-2xl glass shadow-xl hover:border-primary/50 transition-colors group">
            <div className="text-4xl font-bold text-primary mb-2 group-hover:scale-110 transition-transform">10+</div>
            <div className="text-sm text-muted-foreground uppercase tracking-wider font-semibold">
              Projects Delivered
            </div>
          </div>
          <div className="stat-card text-center p-6 rounded-2xl glass shadow-xl hover:border-primary/50 transition-colors group">
            ...
            <div className="text-sm text-muted-foreground uppercase tracking-wider font-semibold">Technologies</div>
          </div>
          <div className="stat-card text-center p-6 rounded-2xl glass shadow-xl hover:border-primary/50 transition-colors group">
            <div className="text-4xl font-bold text-primary mb-2 group-hover:scale-110 transition-transform">100%</div>
            <div className="text-sm text-muted-foreground uppercase tracking-wider font-semibold">Dedication</div>
          </div>
        </div>
      </div>
    </section>
